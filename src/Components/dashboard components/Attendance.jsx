        ...
        <>
            ...
            <div className='w-full block sm:hidden bg-white px-2 rounded-xl shadow-md py-2 col-start-1 col-end-4 md:col-start-3 md:col-end-5'>
                <div className='w-[90%] mx-auto py-2 flex justify-between'>
                    <h1 className='text-[18px] md:text-[20px] font-[500]'>Attendance</h1>
                    <div>
                        <BorderColorRoundedIcon fontSize='medium' className="text-[#5f66e1] mr-2 w-[20px] cursor-pointer active:scale-[0.9] active:text-[#5f65e1e1] transition-all duration-100" onClick={() => setPopUpToggle(!popUpToggle)} />
                    </div>
                </div>
            ...
            {/* overlay */}
            <div onClick={() => setPopUpToggle(false)} className={`fixed bg-black z-[90] inset-0 opacity-60 ${ popUpToggle ? 'block' : 'hidden' }`}></div>
